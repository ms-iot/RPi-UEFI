  ...
  if (ArmPlatformIsPrimaryCore (MpId))
  {
    ...
    // Configure pins 10-19 (GPFSEL1)
    {
      ...
      const UINT32 fixedPinsFunctionMask =
        ...
        (GPIO_FSEL_ALT5 << (14 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |       // UART1_TX
        (GPIO_FSEL_ALT5 << (15 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |       // UART1_RX
    ...
    // Configure pins 20-29 (GPFSEL2)
    {
      UINT32 modifyMask =
        (GPIO_FSEL_MASK << (28 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
        (GPIO_FSEL_MASK << (29 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN));
      ...
      const UINT32 functionMask =
        ...
        (GPIO_FSEL_ALT2 << (28 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // PCM_CLK
        (GPIO_FSEL_ALT2 << (29 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN));    // PCM_FS

      UINT32 u32GPSEL2 = MmioRead32(GPIO_GPFSEL2);

      u32GPSEL2 &= ~modifyMask;
      u32GPSEL2 |= (functionMask & modifyMask);

      MmioWrite32(GPIO_GPFSEL2, u32GPSEL2);
    } // GPFSEL2

    // Configure pins 30-39 (GPFSEL3)
    {
      const UINT32 modifyMask =
        (GPIO_FSEL_MASK << (30 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
        (GPIO_FSEL_MASK << (31 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
        (GPIO_FSEL_MASK << (32 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
        (GPIO_FSEL_MASK << (33 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
      ...
      const UINT32 functionMask =
        (GPIO_FSEL_ALT2 << (30 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // PCM_DIN
        (GPIO_FSEL_ALT2 << (31 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // PCM_DOUT
        (GPIO_FSEL_ALT3 << (32 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // UART0_TX
        (GPIO_FSEL_ALT3 << (33 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |   // UART0_RX
    ...
    {
      const UINT32 modifyMask =
        (GPIO_FSEL_MASK << (46 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
        (GPIO_FSEL_MASK << (47 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |
      ...
      const UINT32 functionMask =
        (GPIO_FSEL_INPUT << (46 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |    // GPIO46
        (GPIO_FSEL_INPUT << (47 % GPIO_FSEL_PINS_PER_REGISTER * GPIO_FSEL_BITS_PER_PIN)) |    // GPIO47
    ...
    DEBUG((DEBUG_INIT, "GPIO_GPFSEL0 0x%08X\n", MmioRead32(GPIO_GPFSEL0)));
    DEBUG((DEBUG_INIT, "GPIO_GPFSEL1 0x%08X\n", MmioRead32(GPIO_GPFSEL1)));
    DEBUG((DEBUG_INIT, "GPIO_GPFSEL2 0x%08X\n", MmioRead32(GPIO_GPFSEL2)));
    DEBUG((DEBUG_INIT, "GPIO_GPFSEL3 0x%08X\n", MmioRead32(GPIO_GPFSEL3)));
    DEBUG((DEBUG_INIT, "GPIO_GPFSEL4 0x%08X\n", MmioRead32(GPIO_GPFSEL4)));
    DEBUG((DEBUG_INIT, "GPIO_GPFSEL5 0x%08X\n", MmioRead32(GPIO_GPFSEL5)));
  }
