...
/* PCI BARs */
#define HERMON_PCI_CONFIG_BAR		0
#define HERMON_PCI_CONFIG_BAR_SIZE	0x100000
#define HERMON_PCI_UAR_BAR		1
...
/* -------------- */ /* TLV Header*/
    ...
    pseudo_bit_t	tlv_hdr_type_res[0x00004];
...
int hermon_transmit(void *hermon, unsigned int mport, void *packet, unsigned int length);
int hermon_set_mac(void *hermon, unsigned int mport, const uint8_t *mac );
