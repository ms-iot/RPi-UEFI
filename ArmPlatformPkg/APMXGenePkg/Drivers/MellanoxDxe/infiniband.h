...
#include "common.h"
#include "ipxe_refcnt.h"
#include "ib_packet.h"
#include "ib_mad.h"
#include "list.h"

#define NUM_IOB_SLOTS 32
#define MAX_PACKET_SZ 0x800  /* >= IB_MAX_PAYLOAD_SIZE */
#define IOB_SLOT_SZ (sizeof(struct io_buffer) + MAX_PACKET_SZ)


/** Number of ConnectX3 Ethernet send work queue entries */
#define HERMON_ETH_NUM_SEND_WQES 4
