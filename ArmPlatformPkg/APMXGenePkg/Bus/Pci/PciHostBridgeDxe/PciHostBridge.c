...
UINTN RootBridgeNumber[XGENE_PCIE_MAX_PORTS] = { 1, 1, 1, 1, 1 };

UINT64 RootBridgeAttribute[XGENE_PCIE_MAX_PORTS][1] = {
...
EFI_PCI_ROOT_BRIDGE_DEVICE_PATH mEfiPciRootBridgeDevicePath[XGENE_PCIE_MAX_PORTS][1] = {
  {
  /* Port 0 */
    {
      {
...
PCI_ROOT_BRIDGE_RESOURCE_APPETURE  mResAppeture[XGENE_PCIE_MAX_PORTS][1] = {
  /* Port 0 */
  {
    {
      0,
      0x1,
      ((UINT64)PCIE0_OB_MEMBASE0_HI << 32) | PCIE0_OB_MEMBASE0_LO,
      ((UINT64)PCIE0_OB_MEMBASE0_HI << 32) | (PCIE0_OB_MEMBASE0_LO + PCIE0_OB_MEMSIZE0 - 1),
      ((UINT64)PCIE0_OB_IOBASE_HI << 32) | PCIE0_OB_IOBASE_LO,
      ((UINT64)PCIE0_OB_IOBASE_HI << 32) | (PCIE0_OB_IOBASE_LO + PCIE0_OB_IOSIZE - 1)
    }
  },
  /* Port 1 */
  {
    {
      0,
      0x1,
      ((UINT64)PCIE1_OB_MEMBASE0_HI << 32) | PCIE1_OB_MEMBASE0_LO,
      ((UINT64)PCIE1_OB_MEMBASE0_HI << 32) | (PCIE1_OB_MEMBASE0_LO + PCIE1_OB_MEMSIZE0 - 1),
      ((UINT64)PCIE1_OB_IOBASE_HI << 32) | PCIE1_OB_IOBASE_LO,
      ((UINT64)PCIE1_OB_IOBASE_HI << 32) | (PCIE1_OB_IOBASE_LO + PCIE1_OB_IOSIZE - 1)
    }
  },
  /* Port 2 */
  {
    {
      0,
      0x1,
      ((UINT64)PCIE2_OB_MEMBASE0_HI << 32) | PCIE2_OB_MEMBASE0_LO,
      ((UINT64)PCIE2_OB_MEMBASE0_HI << 32) | (PCIE2_OB_MEMBASE0_LO + PCIE2_OB_MEMSIZE0 - 1),
      ((UINT64)PCIE2_OB_IOBASE_HI << 32) | PCIE2_OB_IOBASE_LO,
      ((UINT64)PCIE2_OB_IOBASE_HI << 32) | (PCIE2_OB_IOBASE_LO + PCIE2_OB_IOSIZE - 1)
    }
  },
  /* Port 3 */
  {
    {
      0,
      0x1,
      ((UINT64)PCIE3_OB_MEMBASE0_HI << 32) | PCIE3_OB_MEMBASE0_LO,
      ((UINT64)PCIE3_OB_MEMBASE0_HI << 32) | (PCIE3_OB_MEMBASE0_LO + PCIE3_OB_MEMSIZE0 - 1),
      ((UINT64)PCIE3_OB_IOBASE_HI << 32) | PCIE3_OB_IOBASE_LO,
      ((UINT64)PCIE3_OB_IOBASE_HI << 32) | (PCIE3_OB_IOBASE_LO + PCIE3_OB_IOSIZE - 1)
    }
  },
  /* Port 4 */
  {
    {
      0,
      0x1,
      ((UINT64)PCIE4_OB_MEMBASE0_HI << 32) | PCIE4_OB_MEMBASE0_LO,
      ((UINT64)PCIE4_OB_MEMBASE0_HI << 32) | (PCIE4_OB_MEMBASE0_LO + PCIE4_OB_MEMSIZE0 - 1),
      ((UINT64)PCIE4_OB_IOBASE_HI << 32) | PCIE4_OB_IOBASE_LO,
      ((UINT64)PCIE4_OB_IOBASE_HI << 32) | (PCIE4_OB_IOBASE_LO + PCIE4_OB_IOSIZE - 1)
    }
  },
};
  ...
  )
{
  ...
  for (Loop1 = 0; Loop1 < XGENE_PCIE_MAX_PORTS; Loop1++) {
    ...
    XGenePcieSetupHostPost(Loop1, HostBridge);
